...
@TestComponent
public class LoanAmountGreaterIncomeRuleTest {

    private LoanAmountGreaterIncomeRule testComponent = new LoanAmountGreaterIncomeRule();
    ...
    void testEvaluate(){
        ...
        assertEquals(responseTest.recomendation(), CreditRecomendationUtil.APPROVED_FALSE_BY_LOAN_AMOUNT);
    }
}
